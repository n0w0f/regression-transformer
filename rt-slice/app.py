...
from module import get_hf_training_arg_object, get_train_config_dict, prepare_datasets_from_files
...
class RegressionTransformerTrainingPipeline():
    ...
    def train(  # type: ignore
        ...
        try:
            ...
            print(custom_trainer_params)
            print(hf_train_object)
...
if __name__ == "__main__":
    training_pipeline = RegressionTransformerTrainingPipeline()# Assuming you've instantiated the RegressionTransformerTrainingPipeline as training_pipeline

    
    model_args = {
        "training_pipeline_name": "regression-transformer-trainer",
        "tokenizer_name": "/home/so87pot/n0w0f/regression-transformer/slice-assets/tokenizer/slice_vocab.txt",
        "config_name": "/home/so87pot/n0w0f/gt4sd-core/my_regression_transformer/config.json",
        "do_train": True,
        "eval_steps": 100,
        "global_step": 100,
        "augment": 5,
        ...
        "model_path": None,
        "model_type":"xlnet",
        "cache_dir": "/home/so87pot/n0w0f/gt4sd-core/rt-slice/output",
        "config_name": "/home/so87pot/n0w0f/gt4sd-core/my_regression_transformer/config.json",
    }

    training_args = {
        "output_dir": "/home/so87pot/n0w0f/gt4sd-core/rt-slice/output",
        "alternate_steps": 50,
        "eval_accumulation_steps": 1,
        "eval_steps": 100,
        "global_step": 100,
    ...
    dataset_args = {
        ...
        "config_name": "/home/so87pot/n0w0f/gt4sd-core/my_regression_transformer/config.json",
        "do_train": True,
        "output_dir": "/home/so87pot/n0w0f/rt-slice/output",
        "train_data_path": "/home/so87pot/n0w0f/rt-slice/data/train_matbench_dielectric_0.csv",
        "test_data_path": "/home/so87pot/n0w0f/rt-slice/data/train_matbench_dielectric_0.csv",
        ...
        "model_path": None,
        "model_type":"xlnet",
        "cache_dir": "/home/so87pot/n0w0f/rt-slice/output",
    }


    training_pipeline.train(training_args=training_args, 
